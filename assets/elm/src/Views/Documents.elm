...
transformDocument { name, comments, creationDateTime, lastUpdateDateTime } =
    div [ class "col-sm-4 col-md-2" ]
        [ div [ class "thumbnail" ]
            [ img [ alt "", src fakeImage ] []
            , div [ class "caption" ]
                [ h3 [] [ text name ]
                , div [ style [ ( "margin-left", "0" ) ] ]
                    [ dl []
                        [ printPropertyKey "Scan date"
                        , printPropertyValue (printDatetime creationDateTime)
                        , printPropertyKey "Last update"
                        , printPropertyValue (printDatetime lastUpdateDateTime)
                        ]
                    ]
                ]
            ]
